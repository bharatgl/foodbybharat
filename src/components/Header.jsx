    ...
    <header className="z-50 w-screen p-4 Wpx-6 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-base text-textColor hover: bg-slate-100 duration-100 transition-all ease-in-out cursor-pointer">
              Home
            </li>
            <li className="text-base text-textColor hover: bg-slate-100 duration-100 transition-all ease-in -out cursor-pointer">
              Menu
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                <li className="text-base text-textColor duration-100 transition-all ease-in -out cursor-pointer hover:bg-slate-100 px-4 py-2">
                  Home
                </li>
                <li className="text-base text-textColor  duration-100 transition-all ease-in -out cursor-pointer hover:bg-slate-100 px-4 py-2">
                  Menu
