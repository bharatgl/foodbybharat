...
const Header = () => {
  ...
  return (
    <header className="z-50 w-screen  p-4 px-4 md:p-6 md:px-16">
      {/* desktop and tablet  */}
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                ...
                <li className="text-base text-textColor hover:hover: text-headingColor duration-100 transition-all ease-in -out cursor-pointer hover:bg-slate-100 px-4 py-2">
                  Menu
                </li>
                <li className="text-base text-textColor hover:hover: text-headingColor duration-100 transition-all ease-in -out cursor-pointer hover:bg-slate-100 px-4 py-2">
                  About Us
